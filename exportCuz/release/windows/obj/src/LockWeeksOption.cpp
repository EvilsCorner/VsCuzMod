...
HXLINE( 804)		::haxe::Log_obj::trace(HX_("Weeks Locked",4b,55,ca,aa),::hx::SourceInfo(HX_("source_Cuz/Options.hx",eb,e4,c7,28),804,HX_("LockWeeksOption",89,6c,cd,f0),HX_("press",83,53,88,c8)));
