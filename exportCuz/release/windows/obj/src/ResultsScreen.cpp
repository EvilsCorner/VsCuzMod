...
HXDLIN( 205)				_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
...
HXLINE( 215)			::haxe::Log_obj::trace(::PlayState_obj::rep->path,::hx::SourceInfo(HX_("source_Cuz/ResultsScreen.hx",07,3c,d4,aa),215,HX_("ResultsScreen",e2,74,eb,20),HX_("update",09,86,05,87)));
