...
HXLINE( 267)				if (::hx::IsEq( sender,this->scaleStepper )) {
...
HXLINE( 313)				::Array< int > _hx_tmp = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 313)				int _hx_tmp1 = 1;
HXDLIN( 313)				_hx_tmp[_hx_tmp1] = (_hx_tmp->__get(_hx_tmp1) - shiftMult);
