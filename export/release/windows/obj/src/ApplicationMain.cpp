...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Vs Cuz",25,cf,1f,af),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("sikowny",08,a9,36,8f));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Vs Cuz",25,cf,1f,af));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': Vs Cuz",b8,0a,54,0e));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("n/a",40,a1,53,00));
