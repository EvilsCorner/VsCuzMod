...
HXLINE( 140)		::haxe::Log_obj::trace((1 > ::Math_obj::POSITIVE_INFINITY),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),140,HX_("ChartingState",8d,e0,dd,9b),HX_("create",fc,66,0f,7c)));
...
HXLINE( 223)		::haxe::Log_obj::trace(HX_("goin",0d,90,69,44),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),223,HX_("ChartingState",8d,e0,dd,9b),HX_("create",fc,66,0f,7c)));
...
HXLINE( 264)		::haxe::Log_obj::trace((HX_("Song length in MS: ",38,a4,9f,08) + ::flixel::FlxG_obj::sound->music->_length),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),264,HX_("ChartingState",8d,e0,dd,9b),HX_("create",fc,66,0f,7c)));
HXLINE( 266)		{
...
HXLINE( 289)		::haxe::Log_obj::trace((HX_("TARGET ",af,c7,3b,08) + targetY),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),289,HX_("ChartingState",8d,e0,dd,9b),HX_("create",fc,66,0f,7c)));
HXLINE( 291)		{
...
HXLINE( 316)		::haxe::Log_obj::trace(this->height,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),316,HX_("ChartingState",8d,e0,dd,9b),HX_("create",fc,66,0f,7c)));
...
HXLINE( 382)		::haxe::Log_obj::trace(HX_("bruh",23,d0,1d,41),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),382,HX_("ChartingState",8d,e0,dd,9b),HX_("create",fc,66,0f,7c)));
...
HXLINE( 394)		::haxe::Log_obj::trace(HX_("bruh",23,d0,1d,41),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),394,HX_("ChartingState",8d,e0,dd,9b),HX_("create",fc,66,0f,7c)));
HXLINE( 397)		this->add(this->snapText);
HXLINE( 399)		::haxe::Log_obj::trace(HX_("bruh",23,d0,1d,41),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),399,HX_("ChartingState",8d,e0,dd,9b),HX_("create",fc,66,0f,7c)));
HXLINE( 401)		::haxe::Log_obj::trace(HX_("create",fc,66,0f,7c),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),401,HX_("ChartingState",8d,e0,dd,9b),HX_("create",fc,66,0f,7c)));
...
HXLINE( 445)		::haxe::Log_obj::trace(HX_("removed lines and texts",3c,7f,17,5a),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),445,HX_("ChartingState",8d,e0,dd,9b),HX_("regenerateLines",f7,b6,ed,41)));
...
HXDLIN( 500)		_hx_tmp2(_hx_tmp3,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),500,HX_("ChartingState",8d,e0,dd,9b),HX_("addGrid",87,19,a9,80)));
HXLINE( 504)		::haxe::Log_obj::trace((HX_("height of ",70,ee,66,fd) + ::Math_obj::floor(::ChartingState_obj::lengthInSteps)),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),504,HX_("ChartingState",8d,e0,dd,9b),HX_("addGrid",87,19,a9,80)));
...
HXLINE( 574)			::haxe::Log_obj::trace((HX_("trying to save ",97,46,0a,74) + _gthis->currentSelectedEventName),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),574,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 582)			::haxe::Log_obj::trace(HX_("yeah we can save it",99,4d,9e,30),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),582,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 588)			::haxe::Log_obj::trace(( (::Array< ::Dynamic>)(::ChartingState_obj::_song->__Field(HX_("eventObjects",da,5f,a4,12),::hx::paccDynamic)) )->length,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),588,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 600)					::haxe::Log_obj::trace(i->type,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),600,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 636)			::haxe::Log_obj::trace(HX_("end",db,03,4d,00),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),636,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
            		}
...
HXLINE( 644)			::haxe::Log_obj::trace((HX_("adding ",9f,4f,1f,97) + pog2->name),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),644,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 651)			::haxe::Log_obj::trace(HX_("yeah we can add it",3f,aa,e1,d8),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),651,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 685)					::haxe::Log_obj::trace(i->type,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),685,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 705)			::haxe::Log_obj::trace(HX_("BPM CHANGES:",78,b7,42,2d),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),705,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
HXLINE( 707)			{
...
HXLINE( 708)					::haxe::Log_obj::trace(((((((i->bpm + HX_(" - START: ",55,a8,fb,f8)) + i->startBeat) + HX_(" - END: ",ce,26,68,2f)) + i->endBeat) + HX_(" - START-TIME: ",d1,13,6b,73)) + i->startTime),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),708,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
            				}
            			}
...
HXDLIN( 718)			eventRemove(eventRemove1,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),718,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 722)			::haxe::Log_obj::trace(obj1,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),722,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
HXLINE( 724)			if (::hx::IsNull( obj1 )) {
HXLINE( 725)				return;
            			}
HXLINE( 727)			::haxe::Log_obj::trace(HX_("yeah we can remove it it",99,63,09,73),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),727,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 769)					::haxe::Log_obj::trace(i->type,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),769,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXDLIN( 859)			_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),859,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 871)			::haxe::Log_obj::trace((string + HX_(" - value",1e,2f,b8,72)),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),871,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 817)				::haxe::Log_obj::trace(value,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),817,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 832)		::haxe::Log_obj::trace(HX_("bruh",23,d0,1d,41),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),832,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
HXLINE( 835)		if ((firstEvent != HX_("",00,00,00,00))) {
HXLINE( 837)			::haxe::Log_obj::trace(firstEventObject,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),837,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
HXLINE( 838)			eventName->set_text(firstEventObject->name);
HXLINE( 839)			::haxe::Log_obj::trace(HX_("bruh",23,d0,1d,41),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),839,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
HXLINE( 840)			eventType->set_selectedLabel(firstEventObject->type);
HXLINE( 841)			::haxe::Log_obj::trace(HX_("bruh",23,d0,1d,41),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),841,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
HXLINE( 842)			eventValue->set_text(( (::String)(firstEventObject->value) ));
HXLINE( 843)			::haxe::Log_obj::trace(HX_("bruh",23,d0,1d,41),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),843,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
HXLINE( 844)			this->currentSelectedEventName = firstEventObject->name;
HXLINE( 845)			::haxe::Log_obj::trace(HX_("bruh",23,d0,1d,41),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),845,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
HXLINE( 846)			this->currentEventPosition = firstEventObject->position;
HXLINE( 847)			::haxe::Log_obj::trace(HX_("bruh",23,d0,1d,41),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),847,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
HXLINE( 848)			eventPos->set_text((this->currentEventPosition + HX_("",00,00,00,00)));
HXLINE( 849)			::haxe::Log_obj::trace(HX_("bruh",23,d0,1d,41),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),849,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
            		}
...
HXLINE( 895)		::haxe::Log_obj::trace(HX_("bruh",23,d0,1d,41),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),895,HX_("ChartingState",8d,e0,dd,9b),HX_("addEventsUI",ee,88,4b,f2)));
...
HXLINE( 949)			::haxe::Log_obj::trace(HX_("CHECKED!",3a,9f,7d,06),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),949,HX_("ChartingState",8d,e0,dd,9b),HX_("addOptionsUI",d1,b2,cc,81)));
            		}
            		HX_END_LOCAL_FUNC0((void))
...
HXLINE( 970)			::haxe::Log_obj::trace(HX_("CHECKED!",3a,9f,7d,06),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),970,HX_("ChartingState",8d,e0,dd,9b),HX_("addSongUI",6a,02,ad,e5)));
            		}
            		HX_END_LOCAL_FUNC0((void))
...
HXLINE(1196)			::haxe::Log_obj::trace(sect,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),1196,HX_("ChartingState",8d,e0,dd,9b),HX_("addSectionUI",18,75,a5,87)));
...
HXLINE(1301)			::haxe::Log_obj::trace((((HX_("Loading ",44,9a,33,a5) + ::PlayState_obj::pathToSm) + HX_("/",2f,00,00,00)) + ::PlayState_obj::sm->header->MUSIC),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),1301,HX_("ChartingState",8d,e0,dd,9b),HX_("loadSong",1b,f5,f7,bc)));
...
HXLINE(1561)						::haxe::Log_obj::trace((((((HX_("SNAP - ",69,db,50,4d) + this->snap) + HX_(" INCREASE - ",d1,9c,d3,3f)) + increase) + HX_(" - GO TO BEAT ",ea,4d,9e,d6)) + beats),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),1561,HX_("ChartingState",8d,e0,dd,9b),HX_("update",09,86,05,87)));
...
HXLINE(1657)				::haxe::Log_obj::trace((HX_("BPM CHANGE to ",56,07,70,eb) + this->currentBPM),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),1657,HX_("ChartingState",8d,e0,dd,9b),HX_("update",09,86,05,87)));
...
HXLINE(1718)					::haxe::Log_obj::trace(HX_("deelte note",d9,ab,6b,7e),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),1718,HX_("ChartingState",8d,e0,dd,9b),HX_("update",09,86,05,87)));
            				}
            			}
            			HX_END_LOCAL_FUNC1((void))
...
HXDLIN(1915)						::haxe::Log_obj::trace(_hx_tmp,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),1915,HX_("ChartingState",8d,e0,dd,9b),HX_("update",09,86,05,87)));
...
HXLINE(2035)		::haxe::Log_obj::trace((HX_("changing section",72,75,c1,9c) + sec),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),2035,HX_("ChartingState",8d,e0,dd,9b),HX_("changeSection",55,aa,ac,be)));
HXLINE(2037)		if (::hx::IsNotNull(  ::Dynamic(::ChartingState_obj::_song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(sec) )) {
HXLINE(2039)			::haxe::Log_obj::trace(HX_("naw im not null",34,ff,11,38),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),2039,HX_("ChartingState",8d,e0,dd,9b),HX_("changeSection",55,aa,ac,be)));
...
HXLINE(2068)			::haxe::Log_obj::trace(HX_("bro wtf I AM NULL",ec,3a,e8,a2),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),2068,HX_("ChartingState",8d,e0,dd,9b),HX_("changeSection",55,aa,ac,be)));
            		}
            	}
...
HXLINE(2253)		::haxe::Log_obj::trace(section,::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),2253,HX_("ChartingState",8d,e0,dd,9b),HX_("deleteNote",bd,f5,56,9c)));
...
HXLINE(2276)		::haxe::Log_obj::trace(HX_("DELETED!",48,48,2f,bc),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),2276,HX_("ChartingState",8d,e0,dd,9b),HX_("deleteNote",bd,f5,56,9c)));
...
HXLINE(2357)		::haxe::Log_obj::trace(HX_("RECALCULATING SECTION TIMES",1b,8e,4c,d4),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),2357,HX_("ChartingState",8d,e0,dd,9b),HX_("recalculateAllSectionTimes",4f,b8,31,bc)));
HXLINE(2358)		{
...
HXLINE(2390)		::haxe::Log_obj::trace(millisecadd, ::Dynamic(::hx::Anon_obj::Create(5)
            			...
            			->setFixed(3,HX_("fileName",e7,5a,43,62),HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d))
...
HXLINE(2470)		::haxe::Log_obj::trace(((strum1 + HX_(" from ",56,a3,f9,d1)) + this->dummyArrow->y),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),2470,HX_("ChartingState",8d,e0,dd,9b),HX_("addNote",b3,5a,47,85)));
HXLINE(2472)		::haxe::Log_obj::trace(((HX_("adding note with ",0b,a1,76,00) + strum1) + HX_(" from dummyArrow",57,f5,b0,fa)),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),2472,HX_("ChartingState",8d,e0,dd,9b),HX_("addNote",b3,5a,47,85)));
...
HXDLIN(2535)		::haxe::Log_obj::trace( ::Dynamic(::ChartingState_obj::_song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic)),::hx::SourceInfo(HX_("source_Cuz/ChartingState.hx",3c,2d,fe,3d),2535,HX_("ChartingState",8d,e0,dd,9b),HX_("loadLevel",7e,61,9a,8d)));
            	}
