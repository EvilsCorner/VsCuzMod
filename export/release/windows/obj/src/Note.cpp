...
HXLINE( 144)		{
HXLINE( 144)			 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 144)			int _hx_tmp;
...
HXDLIN( 144)			_g->set_x((_g->x + (_hx_tmp + 50)));
            		}
HXLINE( 146)		{
HXLINE( 146)			 ::Note _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 146)			_g1->set_y((_g1->y - ( (Float)(2000) )));
            		}
...
HXLINE( 157)			{
HXLINE( 157)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 157)				_g->set_x((_g->x + (::Note_obj::swagWidth * ( (Float)(::hx::Mod(noteData,4)) ))));
            			}
...
HXLINE( 220)				{
HXLINE( 220)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 220)					_g->set_y((_g->y * ((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.05))));
            				}
HXLINE( 221)				if (::hx::IsNotNull( ::PlayState_obj::instance )) {
HXLINE( 223)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 223)					_g->set_y((_g->y * ::PlayState_obj::instance->songSpeed));
            				}
HXLINE( 226)				if (::PlayState_obj::isPixelStage) {
HXLINE( 227)					{
HXLINE( 227)						 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 227)						_g->set_y((_g->y * ((Float)1.19)));
            					}
HXLINE( 228)					{
HXLINE( 228)						 ::flixel::math::FlxPoint _g1 = prevNote->scale;
HXDLIN( 228)						Float _g2 = _g1->y;
HXDLIN( 228)						_g1->set_y((_g2 * (( (Float)(6) ) / this->get_height())));
            					}
            				}
...
HXLINE( 235)				{
HXLINE( 235)					 ::flixel::math::FlxPoint _g = this->scale;
HXDLIN( 235)					_g->set_y((_g->y * ::PlayState_obj::daPixelZoom));
            				}
...
HXLINE( 241)		{
HXLINE( 241)			 ::Note _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 241)			_g2->set_x((_g2->x + this->offsetX));
            		}
            	}
