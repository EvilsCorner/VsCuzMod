...
HXLINE( 129)		::Dynamic this11 = ::Highscore_obj::songScores;
HXDLIN( 129)		return ( ( ::haxe::ds::StringMap)(this11) )->get_int(::Highscore_obj::formatSong(song,diff));
            	}
...
HXLINE( 137)		::Dynamic this11 = ::Highscore_obj::songCombos;
HXDLIN( 137)		return ( ( ::haxe::ds::StringMap)(this11) )->get_string(::Highscore_obj::formatSong(song,diff));
            	}
...
HXLINE( 145)		::Dynamic this11 = ::Highscore_obj::songScores;
HXDLIN( 145)		return ( ( ::haxe::ds::StringMap)(this11) )->get_int(::Highscore_obj::formatSong((HX_("week",f4,5f,f5,4e) + week),diff));
            	}
