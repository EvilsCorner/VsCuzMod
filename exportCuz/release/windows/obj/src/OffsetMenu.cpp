...
HXLINE( 727)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source_Cuz/Options.hx",eb,e4,c7,28),727,HX_("OffsetMenu",f2,d2,21,3b),HX_("press",83,53,88,c8)));
...
HXLINE( 735)		::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("source_Cuz/Options.hx",eb,e4,c7,28),735,HX_("OffsetMenu",f2,d2,21,3b),HX_("press",83,53,88,c8)));
HXLINE( 736)		{
