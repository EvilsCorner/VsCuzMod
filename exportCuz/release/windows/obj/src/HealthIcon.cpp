...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_63_update,"HealthIcon","update",0x767ac302,"HealthIcon.update","HealthIcon.hx",63,0xf7836789)
...
HXLINE(  48)		this->animation->add(HX_("cuz",88,85,4b,00),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_23,2),0,false,isPlayer,null());
HXLINE(  49)		this->animation->add(HX_("cuzmad",08,aa,2d,44),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_24,2),0,false,isPlayer,null());
HXLINE(  50)		this->animation->add(HX_("demongf",ca,90,cd,ac),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_25,2),0,false,isPlayer,null());
HXLINE(  51)		this->animation->play(_hx_char,null(),null(),null());
HXLINE(  53)		::String _hx_switch_0 = _hx_char;
...
HXDLIN(  56)			goto _hx_goto_0;
            		...
            		_hx_goto_0:;
HXLINE(  59)		this->scrollFactor->set(null(),null());
            	}
...
void HealthIcon_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_63_update)
