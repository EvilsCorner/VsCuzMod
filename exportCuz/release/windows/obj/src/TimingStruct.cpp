...
HXLINE(  42)		::haxe::Log_obj::trace(((HX_("Apparently ",1a,1b,76,58) + msTime) + HX_(" is out of any segs",73,56,95,cc)),::hx::SourceInfo(HX_("source_Cuz/TimingStruct.hx",f4,30,db,e4),42,HX_("TimingStruct",9f,90,60,67),HX_("getTimingAtTimestamp",83,bd,7f,07)));
