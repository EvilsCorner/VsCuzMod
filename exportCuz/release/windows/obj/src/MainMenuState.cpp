...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_247_goToState,"MainMenuState","goToState",0xcf6f00f9,"MainMenuState.goToState","MainMenuState.hx",247,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_277_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",277,0x0e5db805)
...
HXLINE( 194)					this->fancyOpenURL(HX_("https://ninja-muffin24.itch.io/funkin",69,b0,72,92));
            				}
            				else {
...
HXLINE( 206)						if ((_gthis->curSelected != spr->ID)) {
...
HXLINE( 208)							::flixel::tweens::FlxTween_obj::tween(spr, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 218)							if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
...
HXLINE( 220)								::flixel::effects::FlxFlicker_obj::flicker(spr,1,((Float)0.06),false,false, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            							}
            							else {
...
HXLINE( 229)									_gthis->goToState();
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 227)								 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(1, ::Dynamic(new _hx_Closure_2(_gthis)),null());
            							}
            						}
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 198)					this->selectedSomethin = true;
...
HXLINE( 201)					if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
HXLINE( 202)						::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
            					}
HXLINE( 204)					this->menuItems->forEach( ::Dynamic(new _hx_Closure_3(_gthis)),null());
            				}
            			}
            		}
HXLINE( 238)		this->super::update(elapsed);
HXLINE( 240)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_4()),null());
            	}


void MainMenuState_obj::goToState(){
            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_247_goToState)
HXLINE( 248)		::String daChoice = this->optionShit->__get(this->curSelected);
HXLINE( 250)		::String _hx_switch_0 = daChoice;
            		if (  (_hx_switch_0==HX_("freeplay",a0,90,86,22)) ){
HXLINE( 256)			{
HXLINE( 256)				 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 256)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 256)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
HXLINE( 258)			::haxe::Log_obj::trace(HX_("Freeplay Menu Selected",9c,6d,5a,ca),::hx::SourceInfo(HX_("source_Cuz/MainMenuState.hx",f0,6c,f7,72),258,HX_("MainMenuState",59,88,5e,20),HX_("goToState",4e,a5,e1,c9)));
HXLINE( 255)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_0==HX_("options",5e,33,fe,df)) ){
HXLINE( 261)			 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 261)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 261)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
HXDLIN( 261)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_0==HX_("story mode",6e,d7,a7,5e)) ){
HXLINE( 253)			{
HXLINE( 253)				 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 253)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 253)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
HXLINE( 254)			::haxe::Log_obj::trace(HX_("Story Menu Selected",71,ff,9b,4a),::hx::SourceInfo(HX_("source_Cuz/MainMenuState.hx",f0,6c,f7,72),254,HX_("MainMenuState",59,88,5e,20),HX_("goToState",4e,a5,e1,c9)));
HXLINE( 252)			goto _hx_goto_11;
            		}
            		_hx_goto_11:;
            	}
...
void MainMenuState_obj::changeItem(::hx::Null< int >  __o_huh){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::MainMenuState,_gthis) HXARGC(1)
            		void _hx_run( ::flixel::FlxSprite spr){
            			HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_277_changeItem)
HXLINE( 278)			spr->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 280)			bool _hx_tmp;
HXDLIN( 280)			if ((spr->ID == _gthis->curSelected)) {
HXLINE( 280)				_hx_tmp = ::MainMenuState_obj::finishedFunnyMove;
            			}
            			else {
HXLINE( 280)				_hx_tmp = false;
            			}
HXDLIN( 280)			if (_hx_tmp) {
HXLINE( 282)				spr->animation->play(HX_("selected",5b,2a,6d,b1),null(),null(),null());
HXLINE( 283)				 ::flixel::FlxObject _gthis1 = _gthis->camFollow;
HXDLIN( 283)				Float _hx_tmp = spr->getGraphicMidpoint(null())->x;
HXDLIN( 283)				_gthis1->setPosition(_hx_tmp,spr->getGraphicMidpoint(null())->y);
            			}
...
HXLINE( 265)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 267)		if (::MainMenuState_obj::finishedFunnyMove) {
HXLINE( 269)			 ::MainMenuState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 269)			_hx_tmp->curSelected = (_hx_tmp->curSelected + huh);
HXLINE( 271)			if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 272)				this->curSelected = 0;
            			}
HXLINE( 273)			if ((this->curSelected < 0)) {
HXLINE( 274)				this->curSelected = (this->menuItems->length - 1);
            			}
            		}
HXLINE( 276)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
