...
HXLINE(  62)				::haxe::Log_obj::trace(HX_("this is dance double",92,8c,5e,ab),::hx::SourceInfo(HX_("source_Cuz/smTools/SMFile.hx",4f,0d,69,22),62,HX_("smTools.SMFile",e3,d5,c7,d6),HX_("new",60,d0,53,00)));
            			}
HXLINE(  64)			inc = (inc + 5);
HXLINE(  66)			this->measures = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  68)			::String measure = HX_("",00,00,00,00);
HXLINE(  70)			::haxe::Log_obj::trace(data->__get((inc - 1)),::hx::SourceInfo(HX_("source_Cuz/smTools/SMFile.hx",4f,0d,69,22),70,HX_("smTools.SMFile",e3,d5,c7,d6),HX_("new",60,d0,53,00)));
HXLINE(  72)			{
...
HXLINE(  84)			::haxe::Log_obj::trace((this->measures->length + HX_(" Measures",95,d3,b0,47)),::hx::SourceInfo(HX_("source_Cuz/smTools/SMFile.hx",4f,0d,69,22),84,HX_("smTools.SMFile",e3,d5,c7,d6),HX_("new",60,d0,53,00)));
            		} catch( ::Dynamic _hx_e) {
...
HXLINE( 143)		::haxe::Log_obj::trace(HX_("Converting measures",a6,74,71,97),::hx::SourceInfo(HX_("source_Cuz/smTools/SMFile.hx",4f,0d,69,22),143,HX_("smTools.SMFile",e3,d5,c7,d6),HX_("convertToFNF",70,5c,d6,46)));
HXLINE( 145)		{
HXLINE( 145)			int _g = 0;
