...
HXLINE(  31)		::haxe::Log_obj::trace(this->BPMS,::hx::SourceInfo(HX_("source_Cuz/smTools/SMHeader.hx",1e,10,82,9b),31,HX_("smTools.SMHeader",b4,f8,a9,70),HX_("new",60,d0,53,00)));
...
HXLINE(  83)			::haxe::Log_obj::trace((this->changeEvents->length + HX_(" - BPM CHANGES",ef,a9,96,06)),::hx::SourceInfo(HX_("source_Cuz/smTools/SMHeader.hx",1e,10,82,9b),83,HX_("smTools.SMHeader",b4,f8,a9,70),HX_("getBPM",e9,db,19,a3)));
