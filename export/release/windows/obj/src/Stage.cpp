...
HXLINE( 359)			this->camZoom = ((Float)0.7);
HXLINE( 360)			this->curStage = HX_("downtown",b4,33,10,97);
HXLINE( 362)			int offSet = 53;
HXLINE( 365)			 ::flixel::FlxSprite skybox =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-768,-692,null());
HXDLIN( 365)			 ::flixel::FlxSprite skybox1 = skybox->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("downtown/Skybox2",6d,d4,38,41)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 366)			 ::flixel::FlxSprite buildings =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-768,-592,null());
HXDLIN( 366)			 ::flixel::FlxSprite buildings1 = buildings->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("downtown/Buildings",04,82,6e,e1)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 368)			 ::flixel::group::FlxTypedGroup downtownWindows =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE( 369)			 ::flixel::FlxSprite windowTemp =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-768,-592,null());
HXDLIN( 369)			 ::flixel::FlxSprite windowTemp1 = windowTemp->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("downtown/Win0",2f,c0,3a,44)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 371)			 ::flixel::FlxSprite ground =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(-768 + offSet),-592,null());
HXDLIN( 371)			 ::flixel::FlxSprite ground1 = ground->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("downtown/Ground",e2,ce,51,a2)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 372)			 ::flixel::FlxSprite streetlight =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(-768 + offSet),-592,null());
HXDLIN( 372)			 ::flixel::FlxSprite streetlight1 = streetlight->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("downtown/Streetlight",b8,37,2b,0e)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 373)			 ::flixel::FlxSprite frontBushes =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(-768 + offSet),-592,null());
HXDLIN( 373)			 ::flixel::FlxSprite frontBushes1 = frontBushes->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("downtown/Front-Bushes",b5,7c,0e,20)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 374)			 ::flixel::FlxSprite shadeOverlay =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(-768 + offSet),-592,null());
HXDLIN( 374)			 ::flixel::FlxSprite shadeOverlay1 = shadeOverlay->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("downtown/Overlay",d5,66,5d,87)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 377)			skybox1->setGraphicSize(::Std_obj::_hx_int(skybox1->get_width()),null());
HXLINE( 378)			skybox1->scrollFactor->set(((Float)0.45),((Float)0.45));
HXLINE( 379)			skybox1->set_active(false);
HXLINE( 380)			this->toAdd->push(skybox1);
HXLINE( 382)			buildings1->setGraphicSize(::Std_obj::_hx_int(buildings1->get_width()),null());
HXLINE( 383)			buildings1->scrollFactor->set(((Float)0.5),1);
HXLINE( 384)			buildings1->set_active(false);
HXLINE( 385)			this->toAdd->push(buildings1);
HXLINE( 388)			if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 390)				this->swagGroup->set(HX_("downtownWindows",2f,71,ea,64),downtownWindows);
HXLINE( 391)				this->toAdd->push(downtownWindows);
            			}
            			else {
HXLINE( 395)				windowTemp1->setGraphicSize(::Std_obj::_hx_int(windowTemp1->get_width()),null());
HXLINE( 396)				windowTemp1->scrollFactor->set(((Float)0.5),1);
HXLINE( 397)				windowTemp1->set_active(false);
HXLINE( 398)				this->toAdd->push(windowTemp1);
            			}
HXLINE( 401)			{
HXLINE( 402)				{
HXLINE( 403)					 ::flixel::FlxSprite windows =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-768,-592,null());
HXDLIN( 403)					 ::flixel::FlxSprite windows1 = windows->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("downtown/Win",e1,84,19,92) + 0)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 404)					windows1->scrollFactor->set(((Float)0.5),1);
HXLINE( 408)					windows1->setGraphicSize(::Std_obj::_hx_int(windows1->get_width()),null());
HXLINE( 409)					downtownWindows->add(windows1).StaticCast<  ::flixel::FlxSprite >();
            				}
HXLINE( 402)				{
HXLINE( 403)					 ::flixel::FlxSprite windows2 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-768,-592,null());
HXDLIN( 403)					 ::flixel::FlxSprite windows3 = windows2->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("downtown/Win",e1,84,19,92) + 1)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 404)					windows3->scrollFactor->set(((Float)0.5),1);
HXLINE( 407)					windows3->set_visible(false);
HXLINE( 408)					windows3->setGraphicSize(::Std_obj::_hx_int(windows3->get_width()),null());
HXLINE( 409)					downtownWindows->add(windows3).StaticCast<  ::flixel::FlxSprite >();
            				}
HXLINE( 402)				{
HXLINE( 403)					 ::flixel::FlxSprite windows4 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-768,-592,null());
HXDLIN( 403)					 ::flixel::FlxSprite windows5 = windows4->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("downtown/Win",e1,84,19,92) + 2)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 404)					windows5->scrollFactor->set(((Float)0.5),1);
HXLINE( 407)					windows5->set_visible(false);
HXLINE( 408)					windows5->setGraphicSize(::Std_obj::_hx_int(windows5->get_width()),null());
HXLINE( 409)					downtownWindows->add(windows5).StaticCast<  ::flixel::FlxSprite >();
            				}
HXLINE( 402)				{
HXLINE( 403)					 ::flixel::FlxSprite windows6 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-768,-592,null());
HXDLIN( 403)					 ::flixel::FlxSprite windows7 = windows6->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("downtown/Win",e1,84,19,92) + 3)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 404)					windows7->scrollFactor->set(((Float)0.5),1);
HXLINE( 407)					windows7->set_visible(false);
HXLINE( 408)					windows7->setGraphicSize(::Std_obj::_hx_int(windows7->get_width()),null());
HXLINE( 409)					downtownWindows->add(windows7).StaticCast<  ::flixel::FlxSprite >();
            				}
HXLINE( 402)				{
HXLINE( 403)					 ::flixel::FlxSprite windows8 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-768,-592,null());
HXDLIN( 403)					 ::flixel::FlxSprite windows9 = windows8->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("downtown/Win",e1,84,19,92) + 4)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 404)					windows9->scrollFactor->set(((Float)0.5),1);
HXLINE( 407)					windows9->set_visible(false);
HXLINE( 408)					windows9->setGraphicSize(::Std_obj::_hx_int(windows9->get_width()),null());
HXLINE( 409)					downtownWindows->add(windows9).StaticCast<  ::flixel::FlxSprite >();
            				}
            			}
HXLINE( 413)			ground1->setGraphicSize(::Std_obj::_hx_int(ground1->get_width()),null());
HXLINE( 414)			ground1->scrollFactor->set(1,1);
HXLINE( 415)			ground1->set_active(false);
HXLINE( 416)			this->toAdd->push(ground1);
HXLINE( 420)			streetlight1->setGraphicSize(::Std_obj::_hx_int(streetlight1->get_width()),null());
HXLINE( 421)			streetlight1->scrollFactor->set(1,1);
HXLINE( 422)			streetlight1->set_active(false);
HXLINE( 423)			streetlight1->set_alpha(((Float)0.5));
HXLINE( 424)			this->layInFront->__get(2).StaticCast< ::Array< ::Dynamic> >()->push(streetlight1);
HXLINE( 427)			frontBushes1->setGraphicSize(::Std_obj::_hx_int(frontBushes1->get_width()),null());
HXLINE( 428)			frontBushes1->scrollFactor->set(((Float)1.1),((Float)1.1));
HXLINE( 429)			frontBushes1->set_active(false);
HXLINE( 430)			this->layInFront->__get(2).StaticCast< ::Array< ::Dynamic> >()->push(frontBushes1);
HXLINE( 433)			shadeOverlay1->setGraphicSize(::Std_obj::_hx_int(shadeOverlay1->get_width()),null());
HXLINE( 434)			shadeOverlay1->scrollFactor->set(1,1);
HXLINE( 435)			shadeOverlay1->set_active(false);
HXLINE( 436)			shadeOverlay1->set_alpha(((Float)1.0));
HXLINE( 437)			shadeOverlay1->set_visible(false);
HXLINE( 438)			this->layInFront->__get(2).StaticCast< ::Array< ::Dynamic> >()->push(shadeOverlay1);
HXLINE( 439)			this->swagBacks->set(HX_("shade",ad,d8,1c,7c),shadeOverlay1);
HXLINE( 454)			 ::flixel::FlxSprite grid =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,null());
HXDLIN( 454)			 ::flixel::FlxSprite grid1 = grid->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("downtown/superGrid",86,3c,60,91)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 455)			grid1->set_antialiasing(true);
HXLINE( 456)			grid1->setGraphicSize(::Std_obj::_hx_int(grid1->get_width()),null());
HXLINE( 457)			grid1->scrollFactor->set(1,1);
HXLINE( 458)			grid1->set_active(false);
HXLINE( 459)			grid1->updateHitbox();
HXLINE( 460)			grid1->set_alpha(((Float)0.5));
HXLINE( 358)			goto _hx_goto_0;
            		}
...
HXLINE( 467)			this->camZoom = ((Float)0.5);
HXLINE( 468)			this->curStage = HX_("liminalHell",3d,fa,dc,88);
HXLINE( 485)			 ::flixel::FlxSprite liminalHill =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-1497,-1395,null());
HXDLIN( 485)			 ::flixel::FlxSprite liminalHill1 = liminalHill->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("liminal/liminalHill_test",1f,cc,b7,c3)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuzHell",d1,b6,bf,fe)),null(),null(),null(),null(),null());
HXLINE( 486)			 ::flixel::FlxSprite liminalHell =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-1522,-1395,null());
HXDLIN( 486)			 ::flixel::FlxSprite liminalHell1 = liminalHell->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("liminal/liminalHell_test",a3,03,ee,de)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuzHell",d1,b6,bf,fe)),null(),null(),null(),null(),null());
HXLINE( 488)			liminalHell1->setGraphicSize(::Std_obj::_hx_int(liminalHell1->get_width()),null());
HXLINE( 489)			liminalHell1->scrollFactor->set(1,1);
HXLINE( 492)			liminalHell1->set_visible(false);
HXLINE( 493)			this->swagBacks->set(HX_("Hell",dd,5e,e4,2f),liminalHell1);
HXLINE( 494)			this->toAdd->push(liminalHell1);
HXLINE( 496)			liminalHill1->setGraphicSize(::Std_obj::_hx_int(liminalHill1->get_width()),null());
HXLINE( 497)			liminalHill1->scrollFactor->set(1,1);
HXLINE( 500)			liminalHill1->set_visible(true);
HXLINE( 501)			this->swagBacks->set(HX_("Hill",e1,67,e7,2f),liminalHill1);
HXLINE( 502)			this->toAdd->push(liminalHill1);
HXLINE( 506)			 ::flixel::FlxSprite grid =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,null());
HXDLIN( 506)			 ::flixel::FlxSprite grid1 = grid->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("downtown/superGrid",86,3c,60,91)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("weekCuz",f4,4d,eb,24)),null(),null(),null(),null(),null());
HXLINE( 507)			grid1->set_antialiasing(true);
HXLINE( 508)			grid1->setGraphicSize(::Std_obj::_hx_int(grid1->get_width()),null());
HXLINE( 509)			grid1->scrollFactor->set(1,1);
HXLINE( 510)			grid1->set_active(false);
HXLINE( 511)			grid1->updateHitbox();
HXLINE( 512)			grid1->set_alpha(((Float)0.5));
...
HXLINE( 344)			int posX = 400;
HXLINE( 345)			int posY = 200;
HXLINE( 347)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,posX,posY,null());
HXLINE( 348)			bool usecahce = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cacheImages",9a,7c,33,1d),::hx::paccDynamic)) );
HXDLIN( 348)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/animatedEvilSchool",8f,dd,53,cd)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week6",c2,95,be,c7));
HXDLIN( 348)			bg->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/animatedEvilSchool",8f,dd,53,cd)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("week6",c2,95,be,c7))));
HXLINE( 349)			bg->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("background 2",80,07,9d,17),24,null(),null(),null());
HXLINE( 350)			bg->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 351)			bg->scrollFactor->set(((Float)0.8),((Float)0.9));
HXLINE( 352)			bg->scale->set(6,6);
HXLINE( 353)			this->swagBacks->set(HX_("bg",c5,55,00,00),bg);
HXLINE( 354)			this->toAdd->push(bg);
HXLINE( 341)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE( 520)			this->camZoom = ((Float)0.9);
HXLINE( 521)			this->curStage = HX_("stage",be,6a,0b,84);
HXLINE( 522)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-600,-200,null());
HXDLIN( 522)			::String library = null();
HXDLIN( 522)			 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stageback",e5,7b,3b,06)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE( 523)			bg1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 524)			bg1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 525)			bg1->set_active(false);
HXLINE( 526)			this->swagBacks->set(HX_("bg",c5,55,00,00),bg1);
HXLINE( 527)			this->toAdd->push(bg1);
HXLINE( 529)			 ::flixel::FlxSprite stageFront =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-650,600,null());
HXDLIN( 529)			::String library1 = null();
HXDLIN( 529)			 ::flixel::FlxSprite stageFront1 = stageFront->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stagefront",2b,fd,b0,c6)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE( 530)			stageFront1->setGraphicSize(::Std_obj::_hx_int((stageFront1->get_width() * ((Float)1.1))),null());
HXLINE( 531)			stageFront1->updateHitbox();
HXLINE( 532)			stageFront1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 533)			stageFront1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 534)			stageFront1->set_active(false);
HXLINE( 535)			this->swagBacks->set(HX_("stageFront",0b,6d,de,59),stageFront1);
HXLINE( 536)			this->toAdd->push(stageFront1);
HXLINE( 538)			 ::flixel::FlxSprite stageCurtains =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-500,-300,null());
HXDLIN( 538)			::String library2 = null();
HXDLIN( 538)			 ::flixel::FlxSprite stageCurtains1 = stageCurtains->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stagecurtains",df,ec,1a,4b)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2),null(),null(),null(),null(),null());
HXLINE( 539)			stageCurtains1->setGraphicSize(::Std_obj::_hx_int((stageCurtains1->get_width() * ((Float)0.9))),null());
HXLINE( 540)			stageCurtains1->updateHitbox();
HXLINE( 541)			stageCurtains1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 542)			stageCurtains1->scrollFactor->set(((Float)1.3),((Float)1.3));
HXLINE( 543)			stageCurtains1->set_active(false);
HXLINE( 545)			this->swagBacks->set(HX_("stageCurtains",ff,a8,cc,24),stageCurtains1);
HXLINE( 546)			this->toAdd->push(stageCurtains1);
            		}
            		_hx_goto_0:;
            	}
