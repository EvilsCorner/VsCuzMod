...
class PlayState extends MusicBeatState
{
	...
	//variables that can control stage bgs
	...
	override function beatHit()
	{
		...
		if (!endingSong && currentSection != null)
		{
			...
			if (curBeat == 15 && curSong == 'Grappler')
				{
					boyfriend.playAnim('hey', true);
				}
			...
			switch (Stage.curStage)
			{
				...
				case "downtown":
					...
					if (FlxG.save.data.distractions)
					{
						...
						{
							//var downtownWindows = Stage.swagGroup['downtownWindows'];
							downtownWindows.forEach(function(windows:FlxSprite)
							{
							...
							while(curWindow == lastWindow)
							{
								...
								//curWindow = (curWindow + lastWindow+1) % downtownWindows.length;
								//curWindow = (curWindow + 1) % downtownWindows.length;
	...
	var curLight:Int = 0; // why here of all palces
}
//u looked :O -ides
