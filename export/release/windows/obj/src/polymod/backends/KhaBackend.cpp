...
HX_DEFINE_STACK_FRAME(_hx_pos_28feed735110b4ea_30_new,"polymod.backends.KhaBackend","new",0x459d5a99,"polymod.backends.KhaBackend.new","polymod/backends/KhaBackend.hx",30,0x4eaad717)
namespace polymod{
namespace backends{

void KhaBackend_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_28feed735110b4ea_30_new)
HXLINE(  31)		super::__construct();
HXLINE(  32)		::polymod::Polymod_obj::error(HX_("failed_create_backend",13,58,1e,db),HX_("KhaBackend requires the kha library, did you forget to install it?",b9,85,7c,24),null());
            	}
