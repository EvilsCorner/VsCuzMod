...
HXLINE( 405)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SReturn_dyn()));
            			...
            			break;
            			case (int)16: {
HXLINE( 517)				 ::hscript::Expr index = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 517)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 476)						 ::hscript::Expr _g1 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 476)						 ::hscript::Expr _g2 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 485)									 ::hscript::Expr eValue = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 485)									 ::hscript::Expr eKey = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 485)									{
...
HXLINE( 515)					return a;
            			...
            			break;
            			case (int)18: {
HXLINE( 526)				::Array< ::Dynamic> params = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 526)				::String cl = e->_hx_getString(0);
...
HXLINE( 560)				return o;
            			...
            			break;
            			case (int)22: {
HXLINE( 561)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 561)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 561)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 562)					return this->expr(e2);
            			...
            			break;
            			case (int)23: {
HXLINE( 563)				 ::hscript::Expr def = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 563)				::Array< ::Dynamic> cases = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 563)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 395)				return null();
            			...
            			break;
            			case (int)25: {
HXLINE( 580)				::Array< ::Dynamic> _g = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 580)				::String _g1 = e->_hx_getString(0);
