...
HXDLIN(  51)		 ::flixel::FlxSprite menuBG1 = menuBG->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
...
HXDLIN(  80)				staffIcon_->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("Credits/credits",c5,c1,cd,35) + i)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),true,148,189,null(),null());
...
HXLINE( 164)				switch((int)(this->curSelected)){
            					case (int)0: {
HXLINE( 167)						this->fancyOpenURL(HX_("https://twitter.com/acrylicpoppy",f5,42,3c,f3));
            					}
            					break;
            					case (int)1: {
HXLINE( 169)						this->fancyOpenURL(HX_("https://twitter.com/EvilsCorner",7c,6f,1e,aa));
            					}
            					break;
            					case (int)2: {
HXLINE( 171)						this->fancyOpenURL(HX_("https://twitter.com/splootulu",e1,3a,71,2b));
            					}
            					break;
            					case (int)3: {
HXLINE( 173)						this->fancyOpenURL(HX_("https://twitter.com/crashtroid",fd,a3,8f,db));
            					}
            					break;
            					case (int)4: {
HXLINE( 175)						this->fancyOpenURL(HX_("https://twitter.com/Damonj17_",66,3c,89,a6));
            					}
            					break;
            					case (int)5: {
HXLINE( 177)						this->fancyOpenURL(HX_("https://twitter.com/sikowny",10,88,7c,0a));
            					}
            					break;
            					default:{
            					}
