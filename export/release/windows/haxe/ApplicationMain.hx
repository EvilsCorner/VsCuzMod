...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Vs Cuz", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Vs Cuz", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "28";
		app.meta["company"] = "sikowny";
		app.meta["file"] = "Vs Cuz";
		app.meta["name"] = "Friday Night Funkin': Vs Cuz";
		app.meta["packageName"] = "n/a";
