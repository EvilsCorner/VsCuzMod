...
HXDLIN( 418)				int i = (_g5 - 1);
HXLINE( 419)				Float m = (a->__get(i) / b->__get((i - 1)));
HXLINE( 420)				::Array< Float > b1 = b;
HXDLIN( 420)				int i1 = i;
HXDLIN( 420)				b1[i1] = (b1->__get(i1) - (m * c->__get((i - 1))));
HXLINE( 421)				::Array< Float > r1 = r;
HXDLIN( 421)				int i2 = i;
HXDLIN( 421)				r1[i2] = (r1->__get(i2) - (m * r->__get((i - 1))));
            			}
            		}
HXLINE( 424)		control->__get((n - 1)).StaticCast< ::Array< Float > >()[0] = (r->__get((n - 1)) / b->__get((n - 1)));
HXLINE( 425)		int i = (n - 2);
HXLINE( 426)		while((i >= 0)){
HXLINE( 427)			control->__get(i).StaticCast< ::Array< Float > >()[0] = ((r->__get(i) - (c->__get(i) * control->__get((i + 1)).StaticCast< ::Array< Float > >()->__get(0))) / b->__get(i));
HXLINE( 428)			i = (i - 1);
            		}
HXLINE( 432)		{
...
HXDLIN( 432)				int i = (_g7 - 1);
HXLINE( 433)				control->__get(i).StaticCast< ::Array< Float > >()[1] = ((( (Float)(2) ) * K->__get((i + 1))) - control->__get((i + 1)).StaticCast< ::Array< Float > >()->__get(0));
            			}
            		}
