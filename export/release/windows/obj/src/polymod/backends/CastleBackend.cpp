...
HX_DEFINE_STACK_FRAME(_hx_pos_699b620ae42a9617_29_new,"polymod.backends.CastleBackend","new",0xbc3a59f7,"polymod.backends.CastleBackend.new","polymod/backends/CastleBackend.hx",29,0xb7318939)
namespace polymod{
namespace backends{

void CastleBackend_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_699b620ae42a9617_29_new)
HXLINE(  30)		super::__construct();
HXLINE(  31)		::polymod::Polymod_obj::error(HX_("failed_create_backend",13,58,1e,db),HX_("CastleDB support in Polymod has not been implemented yet",53,79,f7,31),null());
            	}
