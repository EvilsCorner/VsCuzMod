...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_60_create,"LoadingState","create",0x65cff835,"LoadingState.create","LoadingState.hx",60,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_81_checkLoadSong,"LoadingState","checkLoadSong",0xc27149ea,"LoadingState.checkLoadSong","LoadingState.hx",81,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_90_checkLoadSong,"LoadingState","checkLoadSong",0xc27149ea,"LoadingState.checkLoadSong","LoadingState.hx",90,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_104_checkLibrary,"LoadingState","checkLibrary",0xd141a10c,"LoadingState.checkLibrary","LoadingState.hx",104,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_227_initSongsManifest,"LoadingState","initSongsManifest",0xe6a6ff04,"LoadingState.initSongsManifest","LoadingState.hx",227,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_249_initSongsManifest,"LoadingState","initSongsManifest",0xe6a6ff04,"LoadingState.initSongsManifest","LoadingState.hx",249,0x53ff9bc9)
...
HXLINE(  74)				introComplete();
            			}
            			HX_END_LOCAL_FUNC1((void))

            			HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_60_create)
HXLINE(  61)			_gthis->callbacks =  ::MultiCallback_obj::__alloc( HX_CTX ,_gthis->onLoad_dyn(),null());
HXLINE(  62)			 ::Dynamic introComplete = _gthis->callbacks->add(HX_("introComplete",45,d3,4c,b2));
HXLINE(  63)			 ::LoadingState _gthis1 = _gthis;
HXDLIN(  63)			_gthis1->checkLoadSong(::LoadingState_obj::getSongPath());
HXLINE(  64)			if (( (bool)(::PlayState_obj::SONG->__Field(HX_("needsVoices",be,05,e9,0d),::hx::paccDynamic)) )) {
HXLINE(  65)				 ::LoadingState _gthis1 = _gthis;
HXDLIN(  65)				_gthis1->checkLoadSong(::LoadingState_obj::getVocalPath());
            			}
HXLINE(  66)			_gthis->checkLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE(  67)			if ((::PlayState_obj::storyWeek > 0)) {
HXLINE(  68)				_gthis->checkLibrary((HX_("week",f4,5f,f5,4e) + ::PlayState_obj::storyWeek));
            			}
            			else {
HXLINE(  70)				_gthis->checkLibrary(HX_("tutorial",9e,8f,b5,82));
            			}
HXLINE(  72)			Float fadeTime = ((Float)0.5);
HXLINE(  73)			::flixel::FlxG_obj::camera->fade(::flixel::FlxG_obj::camera->bgColor,fadeTime,true,null(),null());
HXLINE(  74)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start((fadeTime + ((Float)1.0)), ::Dynamic(new _hx_Closure_0(introComplete)),null());
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(  42)		this->logo->animation->addByPrefix(HX_("bump",f6,0f,20,41),HX_("logo bumpin instance 1",96,67,6b,33),24,null(),null(),null());
...
HXDLIN(  49)		::String _hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("gfCuzDanceTitle",6e,1b,58,e9)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN(  49)		_hx_tmp2->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp3,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("gfCuzDanceTitle",6e,1b,58,e9)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1)));
HXLINE(  50)		this->gfDance->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("GFCuzBump instance 1",27,6c,b8,be),::Array_obj< int >::fromData( _hx_array_data_41ae6215_4,16),HX_("",00,00,00,00),24,false,null(),null());
HXLINE(  51)		this->gfDance->animation->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("GFCuzBump instance 1",27,6c,b8,be),::Array_obj< int >::fromData( _hx_array_data_41ae6215_5,15),HX_("",00,00,00,00),24,false,null(),null());
HXLINE(  53)		this->gfDance->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE(  54)		this->add(this->gfDance);
HXLINE(  55)		this->add(this->logo);
HXLINE(  57)		::LoadingState_obj::initSongsManifest()->onComplete( ::Dynamic(new _hx_Closure_1(_gthis)));
            	}


void LoadingState_obj::checkLoadSong(::String path){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_81_checkLoadSong)
HXDLIN(  81)		if (!(::openfl::utils::IAssetCache_obj::hasSound(::openfl::utils::Assets_obj::cache,path))) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,callback) HXARGC(1)
            			void _hx_run( ::openfl::media::Sound _){
            				HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_90_checkLoadSong)
HXLINE(  90)				callback();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  83)			 ::lime::utils::AssetLibrary library = ::openfl::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
HXLINE(  84)			::String symbolPath = ( (::String)(path.split(HX_(":",3a,00,00,00))->pop()) );
HXLINE(  89)			 ::Dynamic callback = this->callbacks->add((HX_("song:",c5,36,c7,80) + path));
HXLINE(  90)			::openfl::utils::Assets_obj::loadSound(path,null())->onComplete( ::Dynamic(new _hx_Closure_0(callback)));
            		}
            	}
...
HXDLIN(  97)		if (::hx::IsNull( ::openfl::utils::Assets_obj::getLibrary(library) )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,callback) HXARGC(1)
            			void _hx_run( ::openfl::utils::AssetLibrary _){
            				HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_104_checkLibrary)
HXLINE( 104)				callback();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 100)			if (!(::lime::utils::Assets_obj::libraryPaths->exists(library))) {
HXLINE( 101)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Missing library: ",07,45,01,4f) + library)));
            			}
HXLINE( 103)			 ::Dynamic callback = this->callbacks->add((HX_("library:",df,f4,b1,42) + library));
HXLINE( 104)			::openfl::utils::Assets_obj::loadLibrary(library)->onComplete( ::Dynamic(new _hx_Closure_0(callback)));
            		}
            	}
...
HXDLIN( 140)		::String songLowercase = ::StringTools_obj::replace(( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
...
HXDLIN( 145)			goto _hx_goto_16;
            		...
            		_hx_goto_16:;
HXDLIN( 145)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/Voices.",1e,f6,e5,90)) + HX_("ogg",4f,94,54,00));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(LoadingState_obj,getNextState,return )
 ...
 ::lime::app::Future LoadingState_obj::initSongsManifest(){
            		...
            		void _hx_run( ::lime::utils::AssetManifest manifest){
            			HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_227_initSongsManifest)
HXLINE( 228)			if (::hx::IsNull( manifest )) {
HXLINE( 230)				promise->error(((HX_("Cannot parse asset manifest for library \"",cf,1e,cc,48) + id) + HX_("\"",22,00,00,00)));
HXLINE( 231)				return;
            			}
HXLINE( 234)			 ::lime::utils::AssetLibrary library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE( 236)			if (::hx::IsNull( library )) {
HXLINE( 238)				promise->error(((HX_("Cannot open library \"",44,cc,55,e7) + id) + HX_("\"",22,00,00,00)));
            			}
            			else {
HXLINE( 243)				::lime::utils::Assets_obj::libraries->set(id,library);
HXLINE( 244)				library->onChange->add(::lime::utils::Assets_obj::onChange->dispatch_dyn(),null(),null());
HXLINE( 245)				 ::lime::app::Promise_lime_utils_AssetLibrary promise1 = promise;
HXDLIN( 245)				promise1->completeWith(::lime::app::Future_obj::withValue(library));
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))
            		...
            		void _hx_run( ::Dynamic _){
            			HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_249_initSongsManifest)
HXLINE( 249)			promise->error(((HX_("There is no asset library with an ID of \"",8b,06,e2,9a) + id) + HX_("\"",22,00,00,00)));
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_190_initSongsManifest)
HXLINE( 191)		::String id = HX_("songs",fe,36,c7,80);
HXLINE( 192)		 ::lime::app::Promise_lime_utils_AssetLibrary promise =  ::lime::app::Promise_lime_utils_AssetLibrary_obj::__alloc( HX_CTX );
HXLINE( 194)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(id);
HXLINE( 196)		if (::hx::IsNotNull( library )) {
HXLINE( 198)			return ::lime::app::Future_obj::withValue(library);
            		}
HXLINE( 201)		::String path = id;
HXLINE( 202)		::String rootPath = null();
HXLINE( 205)		 ::haxe::ds::StringMap libraryPaths = ::lime::utils::Assets_obj::libraryPaths;
HXLINE( 206)		if (libraryPaths->exists(id)) {
HXLINE( 208)			path = libraryPaths->get_string(id);
HXLINE( 209)			rootPath = ::haxe::io::Path_obj::directory(path);
            		}
            		else {
HXLINE( 213)			if (::StringTools_obj::endsWith(path,HX_(".bundle",30,4a,b8,4e))) {
HXLINE( 215)				rootPath = path;
HXLINE( 216)				path = (path + HX_("/library.json",2a,a7,07,47));
            			}
            			else {
HXLINE( 220)				rootPath = ::haxe::io::Path_obj::directory(path);
            			}
HXLINE( 223)			path = ::lime::utils::Assets_obj::_hx___cacheBreak(path);
            		}
HXLINE( 226)		::lime::utils::AssetManifest_obj::loadFromFile(path,rootPath)->onComplete( ::Dynamic(new _hx_Closure_0(id,promise)))->onError( ::Dynamic(new _hx_Closure_1(id,promise)));
HXLINE( 252)		return promise->future;
            	}
