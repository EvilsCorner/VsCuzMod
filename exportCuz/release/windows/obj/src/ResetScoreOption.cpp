...
HXLINE( 843)		::haxe::Log_obj::trace(HX_("Highscores Wiped",e0,31,8c,e1),::hx::SourceInfo(HX_("source_Cuz/Options.hx",eb,e4,c7,28),843,HX_("ResetScoreOption",f8,72,52,34),HX_("press",83,53,88,c8)));
