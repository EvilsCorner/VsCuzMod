...
HXLINE(  79)		{
HXLINE(  79)			 ::Alphabet _g = titleText;
HXDLIN(  79)			_g->set_x((_g->x + 60));
            		}
HXLINE(  80)		{
HXLINE(  80)			 ::Alphabet _g1 = titleText;
HXDLIN(  80)			_g1->set_y((_g1->y + 40));
            		}
...
HXLINE(  90)		{
HXLINE(  90)			int _g2 = 0;
HXDLIN(  90)			int _g3 = this->optionsArray->length;
...
HXLINE(  94)				{
HXLINE(  94)					 ::Alphabet _g = optionText;
HXDLIN(  94)					_g->set_x((_g->x + 300));
            				}
...
HXLINE( 107)					{
HXLINE( 107)						 ::Alphabet _g = optionText;
HXDLIN( 107)						_g->set_x((_g->x - ( (Float)(80) )));
            					}
