	...
	override function update(elapsed:Float)
	{
		...
		if (acceptInput)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					case 0:
						fancyOpenURL("https://twitter.com/acrylicpoppy");
					case 1:
						fancyOpenURL("https://twitter.com/EvilsCorner");
					case 2:
						fancyOpenURL("https://twitter.com/splootulu");
					case 3:
						fancyOpenURL("https://twitter.com/crashtroid");
					case 4:
						fancyOpenURL("https://twitter.com/Damonj17_");
					case 5:
						fancyOpenURL("https://twitter.com/sikowny");
					default:
				}
			}
