...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_98_beatHit,"GameOverSubstate","beatHit",0xc1b25846,"GameOverSubstate.beatHit","GameOverSubstate.hx",98,0x01fbc1e7)
...
HXLINE(  53)		this->startVibin = false;
...
HXLINE(  21)		::String _hx_switch_0 = ::PlayState_obj::boyfriend->curCharacter;
...
HXLINE(  23)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("demongf",ca,90,cd,ac)) ||  (_hx_switch_0==HX_("demongf4",2a,20,11,87)) ){
HXLINE(  27)			daBf = HX_("demongf",ca,90,cd,ac);
...
HXLINE(  43)		::Conductor_obj::changeBPM(( (Float)(100) ),null());
...
HXLINE(  64)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("InstantRespawn",e7,e4,09,0a),::hx::paccDynamic)) )) {
HXLINE(  66)			 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
HXDLIN(  85)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  85)			_hx_tmp1 = this->bf->animation->_curAnim->finished;
            		}
            		else {
...
HXDLIN(  87)			_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOver",66,92,de,b5) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
HXLINE(  88)			this->startVibin = true;
            		}
HXLINE(  91)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
HXLINE(  93)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
            	}


void GameOverSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_98_beatHit)
HXLINE(  99)		this->super::beatHit();
HXLINE( 101)		bool _hx_tmp;
HXDLIN( 101)		if (this->startVibin) {
HXLINE( 101)			_hx_tmp = !(this->isEnding);
            		}
            		else {
HXLINE( 101)			_hx_tmp = false;
            		}
HXDLIN( 101)		if (_hx_tmp) {
HXLINE( 103)			this->bf->playAnim(HX_("deathLoop",b8,0b,79,2e),true,null(),null());
            		}
            	}
...
HXLINE( 123)					 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
HXDLIN( 123)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 123)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
            				HX_END_LOCAL_FUNC0((void))

            				HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_121_endBullshit)
HXLINE( 121)				::flixel::FlxG_obj::camera->fade(-16777216,2,false, ::Dynamic(new _hx_Closure_0()),null());
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 114)			::PlayState_obj::startTime = ( (Float)(0) );
HXLINE( 115)			this->isEnding = true;
HXLINE( 116)			this->bf->playAnim(HX_("deathConfirm",2c,44,2b,12),true,null(),null());
HXLINE( 117)			{
HXLINE( 117)				 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 117)				_this->cleanup(_this->autoDestroy,true);
            			}
HXLINE( 118)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 118)			::String library = null();
HXDLIN( 118)			_hx_tmp->play(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOverEnd",15,2d,a9,8d) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null(),null(),null());
HXLINE( 119)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.7), ::Dynamic(new _hx_Closure_1()),null());
            		}
            	}
