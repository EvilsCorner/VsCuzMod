...
HXLINE(  56)		{
HXLINE(  56)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN(  56)			bool _hx_tmp;
HXDLIN(  56)			switch((int)(axes->_hx_getIndex())){
...
HXDLIN(  56)				menuBG1->set_x(((( (Float)(_hx_tmp) ) - menuBG1->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  56)				menuBG1->set_y(((( (Float)(_hx_tmp) ) - menuBG1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  67)		 ::flixel::FlxSprite _hx_tmp2 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,400,(( (Float)(::flixel::FlxG_obj::height) ) / ( (Float)(32) )),null());
HXDLIN(  67)		this->consoleBox = _hx_tmp2->makeGraphic(480,::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.9375))),-16777216,null(),null());
...
HXLINE( 101)				{
HXLINE( 101)					 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 101)					if (::hx::IsNull( axes )) {
HXLINE( 101)						axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            					}
...
HXDLIN( 101)						temp->set_x(((( (Float)(_hx_tmp) ) - temp->get_width()) / ( (Float)(2) )));
            					}
...
HXDLIN( 101)						temp->set_y(((( (Float)(_hx_tmp) ) - temp->get_height()) / ( (Float)(2) )));
            					}
            				}
HXLINE( 102)				temp->set_x(temp->x);
...
HXDLIN( 146)			if (_this->keyManager->checkStatusUnsafe(38,_this->status)) {
...
HXDLIN( 153)			if (_this1->keyManager->checkStatusUnsafe(40,_this1->status)) {
...
HXDLIN( 181)			if (_this2->keyManager->checkStatusUnsafe(39,_this2->status)) {
...
HXDLIN( 185)			if (_this3->keyManager->checkStatusUnsafe(37,_this3->status)) {
...
HXDLIN( 202)		 ::CreditsMenu _gthis = ::hx::ObjectPtr<OBJ_>(this);
