...
static const ::String _hx_array_data_205e8859_1[] = {
	HX_("story mode",6e,d7,a7,5e),HX_("freeplay",a0,90,86,22),HX_("credit",39,a4,11,7c),HX_("options",5e,33,fe,df),
};
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_193_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",193,0x0e5db805)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_234_goToState,"MainMenuState","goToState",0xcf6f00f9,"MainMenuState.goToState","MainMenuState.hx",234,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_266_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",266,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_255_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",255,0x0e5db805)
...
HXLINE( 229)			spr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 182)			if (::PlayerSettings_obj::player1->controls->_accept->check()) {
            				...
            				void _hx_run( ::flixel::FlxSprite spr){
            					HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_193_update)
HXLINE( 193)					if ((_gthis->curSelected != spr->ID)) {
...
HXLINE( 195)						::flixel::tweens::FlxTween_obj::tween(spr, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 205)						if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
...
HXLINE( 216)								_gthis->goToState();
            							}
            							HX_END_LOCAL_FUNC1((void))

HXLINE( 214)							 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(1, ::Dynamic(new _hx_Closure_2(_gthis)),null());
            						}
            					}
            				}
            				HX_END_LOCAL_FUNC1((void))
...
HXDLIN( 186)				_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
HXLINE( 188)				if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
HXLINE( 189)					::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
            				}
HXLINE( 191)				this->menuItems->forEach( ::Dynamic(new _hx_Closure_3(_gthis)),null());
            			}
            		}
HXLINE( 225)		this->super::update(elapsed);
HXLINE( 227)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_4()),null());
            	}


void MainMenuState_obj::goToState(){
            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_234_goToState)
HXLINE( 235)		::String daChoice = this->optionShit->__get(this->curSelected);
HXLINE( 237)		::String _hx_switch_0 = daChoice;
            		if (  (_hx_switch_0==HX_("credit",39,a4,11,7c)) ){
HXLINE( 248)			 ::flixel::FlxState nextState =  ::CreditsMenu_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 243)			 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 243)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 243)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
HXDLIN( 243)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_0==HX_("options",5e,33,fe,df)) ){
HXLINE( 250)			 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 240)			 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 240)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 240)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
HXDLIN( 240)			goto _hx_goto_11;
            		}
            		_hx_goto_11:;
            	}
...
void MainMenuState_obj::changeItem(::hx::Null< int >  __o_huh){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::MainMenuState,_gthis) HXARGC(1)
            		void _hx_run( ::flixel::FlxSprite spr){
            			HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_266_changeItem)
HXLINE( 267)			spr->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 269)			bool _hx_tmp;
HXDLIN( 269)			if ((spr->ID == _gthis->curSelected)) {
HXLINE( 269)				_hx_tmp = ::MainMenuState_obj::finishedFunnyMove;
            			}
            			else {
HXLINE( 269)				_hx_tmp = false;
            			}
HXDLIN( 269)			if (_hx_tmp) {
HXLINE( 271)				spr->animation->play(HX_("selected",5b,2a,6d,b1),null(),null(),null());
HXLINE( 272)				 ::flixel::FlxObject _gthis1 = _gthis->camFollow;
HXDLIN( 272)				Float _hx_tmp = spr->getGraphicMidpoint(null())->x;
HXDLIN( 272)				_gthis1->setPosition(_hx_tmp,spr->getGraphicMidpoint(null())->y);
            			}
HXLINE( 275)			spr->updateHitbox();
            		}
            		HX_END_LOCAL_FUNC1((void))

            		int huh = __o_huh.Default(0);
            	HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_255_changeItem)
HXLINE( 254)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 256)		if (::MainMenuState_obj::finishedFunnyMove) {
HXLINE( 258)			 ::MainMenuState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 258)			_hx_tmp->curSelected = (_hx_tmp->curSelected + huh);
HXLINE( 260)			if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 261)				this->curSelected = 0;
            			}
HXLINE( 262)			if ((this->curSelected < 0)) {
HXLINE( 263)				this->curSelected = (this->menuItems->length - 1);
            			}
            		}
HXLINE( 265)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
