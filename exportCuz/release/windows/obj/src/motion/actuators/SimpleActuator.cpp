...
HXLINE( 138)				 ::Dynamic target = this->target;
HXDLIN( 138)				 ::Dynamic value = ::hx::IsGreater( ::Reflect_obj::field(this->properties,HX_("alpha",5e,a7,96,21)),0 );
HXDLIN( 138)				if (::Reflect_obj::hasField(target,HX_("visible",72,78,24,a3))) {
HXLINE( 138)					::Reflect_obj::setField(target,HX_("visible",72,78,24,a3),value);
            				}
            				else {
HXLINE( 138)					::Reflect_obj::setProperty(target,HX_("visible",72,78,24,a3),value);
            				}
            			}
            		}
            	}
...
HXDLIN( 166)				 ::Dynamic value = this->cacheVisible;
HXDLIN( 166)				if (::Reflect_obj::hasField(target,HX_("visible",72,78,24,a3))) {
HXLINE( 166)					::Reflect_obj::setField(target,HX_("visible",72,78,24,a3),value);
            				}
            				else {
HXLINE( 166)					::Reflect_obj::setProperty(target,HX_("visible",72,78,24,a3),value);
            				}
            			}
            		}
...
HXLINE( 252)				if (::Std_obj::isOfType(start,( ( ::Dynamic)(::hx::ClassOf< ::Float >()) ))) {
...
HXLINE( 277)			_hx_tmp = ::Std_obj::isOfType(this->target,( ( ::Dynamic)(::hx::ClassOf< ::openfl::display::DisplayObject >()) ));
            		}
            		else {
...
HXLINE( 285)			 ::Dynamic target = this->target;
HXDLIN( 285)			 ::Dynamic value = null();
HXDLIN( 285)			if (::Reflect_obj::hasField(target,HX_("visible",72,78,24,a3))) {
HXLINE( 285)				value = ::Reflect_obj::field(target,HX_("visible",72,78,24,a3));
            			}
            			else {
HXLINE( 285)				value = ::Reflect_obj::getProperty(target,HX_("visible",72,78,24,a3));
            			}
HXDLIN( 285)			this->cacheVisible = ( (bool)(value) );
HXLINE( 286)			{
HXLINE( 286)				 ::Dynamic target1 = this->target;
HXDLIN( 286)				 ::Dynamic value1 = true;
HXDLIN( 286)				if (::Reflect_obj::hasField(target1,HX_("visible",72,78,24,a3))) {
HXLINE( 286)					::Reflect_obj::setField(target1,HX_("visible",72,78,24,a3),value1);
            				}
            				else {
HXLINE( 286)					::Reflect_obj::setProperty(target1,HX_("visible",72,78,24,a3),value1);
            				}
            			}
            		}
...
HXLINE( 488)						details = this->propertyDetails->__get(i).StaticCast<  ::motion::actuators::PropertyDetails >();
...
HXLINE( 507)				{
HXLINE( 507)					int _g = 0;
HXDLIN( 507)					int _g1 = this->detailsLength;
HXDLIN( 507)					while((_g < _g1)){
HXLINE( 507)						_g = (_g + 1);
HXDLIN( 507)						int i = (_g - 1);
HXLINE( 509)						details = this->propertyDetails->__get(i).StaticCast<  ::motion::actuators::PropertyDetails >();
...
HXDLIN( 553)						_hx_tmp = ::hx::IsEq( value,0 );
            					}
            					else {
HXLINE( 553)						_hx_tmp = false;
            					}
HXDLIN( 553)					if (_hx_tmp) {
HXLINE( 555)						 ::Dynamic target = this->target;
HXDLIN( 555)						 ::Dynamic value = false;
HXDLIN( 555)						if (::Reflect_obj::hasField(target,HX_("visible",72,78,24,a3))) {
HXLINE( 555)							::Reflect_obj::setField(target,HX_("visible",72,78,24,a3),value);
            						}
            						else {
HXLINE( 555)							::Reflect_obj::setProperty(target,HX_("visible",72,78,24,a3),value);
            						}
            					}
