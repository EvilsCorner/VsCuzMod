...
HX_DEFINE_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_256_new,"MultiCallback","new",0x3682e930,"MultiCallback.new","LoadingState.hx",256,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_273_add,"MultiCallback","add",0x36790af1,"MultiCallback.add","LoadingState.hx",273,0x53ff9bc9)

void MultiCallback_obj::__construct( ::Dynamic callback,::String logId){
            	HX_GC_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_256_new)
HXLINE( 264)		this->fired = ::Array_obj< ::String >::__new();
HXLINE( 263)		this->unfired =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 261)		this->numRemaining = 0;
HXLINE( 260)		this->length = 0;
HXLINE( 259)		this->logId = null();
HXLINE( 268)		this->callback = callback;
HXLINE( 269)		this->logId = logId;
            	}
...
HXLINE( 280)			if (_gthis->unfired->exists(id)) {
HXLINE( 282)				_gthis->unfired->remove(id);
HXLINE( 283)				_gthis->fired->push(id);
HXLINE( 284)				_gthis->numRemaining--;
HXLINE( 286)				bool func = ::hx::IsNotNull( _gthis->logId );
HXLINE( 289)				if ((_gthis->numRemaining == 0)) {
HXLINE( 291)					bool func = ::hx::IsNotNull( _gthis->logId );
HXLINE( 293)					_gthis->callback();
            				}
            			}
            			else {
HXLINE( 297)				bool func = ::hx::IsNotNull( _gthis->logId );
            			}
            		}
            	...
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_273_add)
HXLINE( 272)		 ::MultiCallback _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 274)		id = (((HX_("",00,00,00,00) + this->length) + HX_(":",3a,00,00,00)) + id);
HXLINE( 275)		this->length++;
HXLINE( 276)		this->numRemaining++;
HXLINE( 277)		 ::Dynamic func = null();
HXLINE( 278)		func =  ::Dynamic(new _hx_Closure_0(id,_gthis));
HXLINE( 299)		this->unfired->set(id,func);
HXLINE( 300)		return func;
            	}
