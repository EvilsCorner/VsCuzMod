...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_234_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",234,0x1a8855ec)
...
HXLINE(  55)		this->arrowAngles = ::Array_obj< int >::fromData( _hx_array_data_33e34412_1,4);
...
HXLINE(  53)		this->dataColor = ::Array_obj< ::String >::fromData( _hx_array_data_33e34412_2,4);
...
HXLINE( 130)			if ((noteTypeCheck == HX_("pixel",86,c6,a3,c2))) {
...
HXLINE( 137)				{
HXLINE( 138)					{
HXLINE( 139)						this->animation->add((this->dataColor->__get(0) + HX_("Scroll",2d,4c,f9,7b)),::Array_obj< int >::fromData( _hx_array_data_33e34412_3,1),null(),null(),null(),null());
HXLINE( 140)						this->animation->add((this->dataColor->__get(0) + HX_("hold",3f,c9,12,45)),::Array_obj< int >::fromData( _hx_array_data_33e34412_4,1),null(),null(),null(),null());
HXLINE( 141)						this->animation->add((this->dataColor->__get(0) + HX_("holdend",fc,4b,02,b8)),::Array_obj< int >::fromData( _hx_array_data_33e34412_5,1),null(),null(),null(),null());
            					}
HXLINE( 138)					{
HXLINE( 139)						this->animation->add((this->dataColor->__get(1) + HX_("Scroll",2d,4c,f9,7b)),::Array_obj< int >::fromData( _hx_array_data_33e34412_6,1),null(),null(),null(),null());
HXLINE( 140)						this->animation->add((this->dataColor->__get(1) + HX_("hold",3f,c9,12,45)),::Array_obj< int >::fromData( _hx_array_data_33e34412_7,1),null(),null(),null(),null());
HXLINE( 141)						this->animation->add((this->dataColor->__get(1) + HX_("holdend",fc,4b,02,b8)),::Array_obj< int >::fromData( _hx_array_data_33e34412_8,1),null(),null(),null(),null());
            					}
HXLINE( 138)					{
HXLINE( 139)						this->animation->add((this->dataColor->__get(2) + HX_("Scroll",2d,4c,f9,7b)),::Array_obj< int >::fromData( _hx_array_data_33e34412_9,1),null(),null(),null(),null());
HXLINE( 140)						this->animation->add((this->dataColor->__get(2) + HX_("hold",3f,c9,12,45)),::Array_obj< int >::fromData( _hx_array_data_33e34412_10,1),null(),null(),null(),null());
HXLINE( 141)						this->animation->add((this->dataColor->__get(2) + HX_("holdend",fc,4b,02,b8)),::Array_obj< int >::fromData( _hx_array_data_33e34412_11,1),null(),null(),null(),null());
            					}
HXLINE( 138)					{
HXLINE( 139)						this->animation->add((this->dataColor->__get(3) + HX_("Scroll",2d,4c,f9,7b)),::Array_obj< int >::fromData( _hx_array_data_33e34412_12,1),null(),null(),null(),null());
HXLINE( 140)						this->animation->add((this->dataColor->__get(3) + HX_("hold",3f,c9,12,45)),::Array_obj< int >::fromData( _hx_array_data_33e34412_13,1),null(),null(),null(),null());
HXLINE( 141)						this->animation->add((this->dataColor->__get(3) + HX_("holdend",fc,4b,02,b8)),::Array_obj< int >::fromData( _hx_array_data_33e34412_14,1),null(),null(),null(),null());
            					}
            				}
...
HXDLIN( 147)				::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 147)				this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 149)				{
HXLINE( 150)					{
...
HXLINE( 166)		{
HXLINE( 166)			 ::Note _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 166)			_g2->set_x((_g2->x + (::Note_obj::swagWidth * ( (Float)(noteData) ))));
            		}
HXLINE( 167)		this->animation->play((this->dataColor->__get(noteData) + HX_("Scroll",2d,4c,f9,7b)),null(),null(),null());
HXLINE( 168)		this->originColor = noteData;
HXLINE( 170)		bool _hx_tmp;
HXDLIN( 170)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("stepMania",06,56,8a,73),::hx::paccDynamic)) )) {
HXLINE( 170)			_hx_tmp = !(this->isSustainNote);
            		}
            		else {
HXLINE( 170)			_hx_tmp = false;
            		}
HXDLIN( 170)		if (_hx_tmp) {
HXLINE( 172)			Float strumCheck = this->rStrumTime;
HXLINE( 178)			int ind = ::Std_obj::_hx_int(( (Float)(::Math_obj::round((strumCheck / (::Conductor_obj::stepCrochet / ( (Float)(2) ))))) ));
HXLINE( 180)			int col = 0;
HXLINE( 181)			col = this->quantityColor->__get(::hx::Mod(ind,8));
HXLINE( 183)			this->animation->play((this->dataColor->__get(col) + HX_("Scroll",2d,4c,f9,7b)),null(),null(),null());
HXLINE( 184)			 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 184)			_hx_tmp->localAngle = (_hx_tmp->localAngle - ( (Float)(this->arrowAngles->__get(col)) ));
HXLINE( 185)			 ::Note _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 185)			_hx_tmp1->localAngle = (_hx_tmp1->localAngle + this->arrowAngles->__get(noteData));
HXLINE( 186)			this->originColor = col;
            		}
HXLINE( 193)		bool _hx_tmp1;
HXDLIN( 193)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )) {
HXLINE( 193)			_hx_tmp1 = ( (bool)(sustainNote) );
            		}
            		else {
HXLINE( 193)			_hx_tmp1 = false;
            		}
HXDLIN( 193)		if (_hx_tmp1) {
HXLINE( 194)			this->set_flipY(true);
            		}
HXLINE( 196)		Float stepHeight = (((Float)0.45) * ::Conductor_obj::stepCrochet);
HXDLIN( 196)		Float stepHeight1;
HXDLIN( 196)		if ((::PlayStateChangeables_obj::scrollSpeed == 1)) {
HXLINE( 196)			stepHeight1 = ( (Float)(::PlayState_obj::SONG->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) );
            		}
            		else {
HXLINE( 196)			stepHeight1 = ::PlayStateChangeables_obj::scrollSpeed;
            		}
HXDLIN( 196)		Float stepHeight2 = (stepHeight * ::flixel::math::FlxMath_obj::roundDecimal(stepHeight1,2));
HXLINE( 198)		bool _hx_tmp2;
HXDLIN( 198)		if (this->isSustainNote) {
HXLINE( 198)			_hx_tmp2 = ::hx::IsNotNull( prevNote );
            		}
            		else {
...
HXDLIN( 203)				Float _g1 = _g->x;
HXDLIN( 203)				_g->set_x((_g1 + (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 205)			this->originColor = prevNote->originColor;
HXLINE( 207)			this->animation->play((this->dataColor->__get(this->originColor) + HX_("holdend",fc,4b,02,b8)),null(),null(),null());
HXLINE( 208)			this->updateHitbox();
HXLINE( 210)			{
HXLINE( 210)				 ::Note _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 210)				Float _g3 = _g2->x;
HXDLIN( 210)				_g2->set_x((_g3 - (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 214)			if (( (bool)(inCharter) )) {
HXLINE( 215)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 215)				_g->set_x((_g->x + 30));
            			}
HXLINE( 217)			if (prevNote->isSustainNote) {
HXLINE( 219)				prevNote->animation->play((this->dataColor->__get(prevNote->originColor) + HX_("hold",3f,c9,12,45)),null(),null(),null());
HXLINE( 220)				prevNote->updateHitbox();
HXLINE( 222)				{
HXLINE( 222)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 222)					Float _g1 = _g->y;
HXDLIN( 222)					_g->set_y((_g1 * ((stepHeight2 + 1) / prevNote->get_height())));
            				}
HXLINE( 223)				prevNote->updateHitbox();
HXLINE( 224)				prevNote->noteYOff = ::Math_obj::round(-(prevNote->offset->y));
HXLINE( 228)				this->noteYOff = ::Math_obj::round(-(this->offset->y));
            			}
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_234_update)
HXLINE( 235)		this->super::update(elapsed);
HXLINE( 236)		this->set_angle((this->modAngle + this->localAngle));
HXLINE( 238)		if (!(this->modifiedByLua)) {
HXLINE( 240)			if (!(this->sustainActive)) {
HXLINE( 242)				this->set_alpha(((Float)0.3));
            			}
            		}
HXLINE( 246)		if (this->mustPress) {
HXLINE( 249)			if (this->isSustainNote) {
HXLINE( 251)				bool _hx_tmp;
HXDLIN( 251)				if ((this->strumTime > (::Conductor_obj::songPosition - (::Conductor_obj::safeZoneOffset * ((Float)1.5))))) {
HXLINE( 251)					_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * ((Float)0.5))));
            				}
            				else {
HXLINE( 251)					_hx_tmp = false;
            				}
HXDLIN( 251)				if (_hx_tmp) {
HXLINE( 253)					this->canBeHit = true;
            				}
            				else {
HXLINE( 255)					this->canBeHit = false;
            				}
            			}
            			else {
HXLINE( 259)				bool _hx_tmp;
HXDLIN( 259)				if ((this->strumTime > (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 259)					_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + ::Conductor_obj::safeZoneOffset));
            				}
            				else {
HXLINE( 259)					_hx_tmp = false;
            				}
HXDLIN( 259)				if (_hx_tmp) {
HXLINE( 261)					this->canBeHit = true;
            				}
            				else {
...
HXDLIN( 266)			if ((this->strumTime < (::Conductor_obj::songPosition - (::Conductor_obj::safeZoneOffset * ::Conductor_obj::timeScale)))) {
HXLINE( 266)				_hx_tmp = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 266)				_hx_tmp = false;
            			}
HXDLIN( 266)			if (_hx_tmp) {
HXLINE( 267)				this->tooLate = true;
            			}
            		}
            		else {
HXLINE( 271)			this->canBeHit = false;
HXLINE( 273)			if ((this->strumTime <= ::Conductor_obj::songPosition)) {
HXLINE( 274)				this->wasGoodHit = true;
            			}
            		}
HXLINE( 277)		if (this->tooLate) {
HXLINE( 279)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 280)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}
