...
HXLINE( 347)		{
HXLINE( 347)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN( 347)			bool _hx_tmp11;
HXDLIN( 347)			switch((int)(axes->_hx_getIndex())){
            				case (int)0: case (int)2: {
HXLINE( 347)					_hx_tmp11 = true;
            				}
            				break;
            				default:{
HXLINE( 347)					_hx_tmp11 = false;
            				}
            			}
HXDLIN( 347)			if (_hx_tmp11) {
HXLINE( 347)				int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN( 347)				logo1->set_x(((( (Float)(_hx_tmp) ) - logo1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 347)			bool _hx_tmp12;
HXDLIN( 347)			switch((int)(axes->_hx_getIndex())){
            				case (int)1: case (int)2: {
HXLINE( 347)					_hx_tmp12 = true;
            				}
            				break;
            				default:{
HXLINE( 347)					_hx_tmp12 = false;
            				}
            			}
HXDLIN( 347)			if (_hx_tmp12) {
HXLINE( 347)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN( 347)				logo1->set_y(((( (Float)(_hx_tmp) ) - logo1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE( 362)		{
HXLINE( 362)			 ::Alphabet _this = this->credTextShit;
HXDLIN( 362)			 ::flixel::util::FlxAxes axes1 = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN( 362)			bool _hx_tmp13;
HXDLIN( 362)			switch((int)(axes1->_hx_getIndex())){
            				case (int)0: case (int)2: {
HXLINE( 362)					_hx_tmp13 = true;
            				}
            				break;
            				default:{
HXLINE( 362)					_hx_tmp13 = false;
            				}
            			}
HXDLIN( 362)			if (_hx_tmp13) {
HXLINE( 362)				int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN( 362)				_this->set_x(((( (Float)(_hx_tmp) ) - _this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 362)			bool _hx_tmp14;
HXDLIN( 362)			switch((int)(axes1->_hx_getIndex())){
            				case (int)1: case (int)2: {
HXLINE( 362)					_hx_tmp14 = true;
            				}
            				break;
            				default:{
HXLINE( 362)					_hx_tmp14 = false;
            				}
            			}
HXDLIN( 362)			if (_hx_tmp14) {
HXLINE( 362)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN( 362)				_this->set_y(((( (Float)(_hx_tmp) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 366)		this->credTextShit->set_visible(false);
HXLINE( 368)		 ::flixel::FlxSprite _hx_tmp15 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.52)),null());
...
HXDLIN( 368)		this->ngSpr = _hx_tmp15->loadGraphic(returnAsset1,null(),null(),null(),null(),null());
HXLINE( 369)		this->add(this->ngSpr);
HXLINE( 370)		this->ngSpr->set_visible(false);
HXLINE( 371)		 ::flixel::FlxSprite _hx_tmp16 = this->ngSpr;
HXDLIN( 371)		_hx_tmp16->setGraphicSize(::Std_obj::_hx_int((this->ngSpr->get_width() * ((Float)0.8))),null());
HXLINE( 372)		this->ngSpr->updateHitbox();
HXLINE( 373)		{
HXLINE( 373)			 ::flixel::FlxSprite _this1 = this->ngSpr;
HXDLIN( 373)			 ::flixel::util::FlxAxes axes2 = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 373)			if (::hx::IsNull( axes2 )) {
HXLINE( 373)				axes2 = ::flixel::util::FlxAxes_obj::XY_dyn();
            			}
HXDLIN( 373)			bool _hx_tmp17;
HXDLIN( 373)			switch((int)(axes2->_hx_getIndex())){
            				case (int)0: case (int)2: {
HXLINE( 373)					_hx_tmp17 = true;
            				}
            				break;
            				default:{
...
HXDLIN( 373)				_this1->set_x(((( (Float)(_hx_tmp) ) - _this1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 373)			bool _hx_tmp18;
HXDLIN( 373)			switch((int)(axes2->_hx_getIndex())){
            				case (int)1: case (int)2: {
HXLINE( 373)					_hx_tmp18 = true;
            				}
            				break;
            				default:{
...
HXDLIN( 373)				_this1->set_y(((( (Float)(_hx_tmp) ) - _this1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXDLIN( 405)		 ::TitleState _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXDLIN( 410)		if (!(_this->keyManager->checkStatusUnsafe(13,_this->status))) {
...
HXLINE( 527)			{
HXLINE( 527)				 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 527)				if (::hx::IsNull( axes )) {
HXLINE( 527)					axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            				}
HXDLIN( 527)				bool _hx_tmp;
HXDLIN( 527)				switch((int)(axes->_hx_getIndex())){
            					case (int)0: case (int)2: {
...
HXLINE( 527)					int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN( 527)					money->set_x(((( (Float)(_hx_tmp) ) - money->get_width()) / ( (Float)(2) )));
            				}
...
HXLINE( 527)					int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN( 527)					money->set_y(((( (Float)(_hx_tmp) ) - money->get_height()) / ( (Float)(2) )));
            				}
            			}
HXLINE( 528)			money->set_y((money->y + (((i * 60) + 200) + offset)));
HXLINE( 529)			bool _hx_tmp2;
HXDLIN( 529)			if (::hx::IsNotNull( this->credGroup )) {
HXLINE( 529)				_hx_tmp2 = ::hx::IsNotNull( this->textGroup );
            			}
            			else {
...
HXLINE( 540)			{
HXLINE( 540)				 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 540)				if (::hx::IsNull( axes )) {
HXLINE( 540)					axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            				}
HXDLIN( 540)				bool _hx_tmp;
HXDLIN( 540)				switch((int)(axes->_hx_getIndex())){
            					case (int)0: case (int)2: {
...
HXLINE( 540)					int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN( 540)					coolText->set_x(((( (Float)(_hx_tmp) ) - coolText->get_width()) / ( (Float)(2) )));
            				}
...
HXLINE( 540)					int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN( 540)					coolText->set_y(((( (Float)(_hx_tmp) ) - coolText->get_height()) / ( (Float)(2) )));
            				}
            			}
HXLINE( 541)			coolText->set_y((coolText->y + (((this->textGroup->length * 60) + 200) + offset)));
...
HXDLIN( 645)		 ::TitleState _gthis = ::hx::ObjectPtr<OBJ_>(this);
